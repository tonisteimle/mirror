...
import { SpacingSnapService, shouldBypassSnapping } from '../../studio/visual/snap'
...
describe('SpacingSnapService — token parsing', () => {
  it('extracts spacing tokens from source for pad/mar/gap', () => {
    ...
    const svc = new SpacingSnapService(() => source)
...
describe('SpacingSnapService — token snap', () => {
  it('snaps within threshold to closest token', () => {
    const svc = new SpacingSnapService(() => 's.pad: 4\nm.pad: 8\nl.pad: 16\n')
...
describe('SpacingSnapService — grid snap', () => {
  it('rounds value to grid size', () => {
    const svc = new SpacingSnapService(() => '')
...
describe('SpacingSnapService — combined snapSpacing', () => {
  ...
  it('falls back to grid snapping when no tokens for type', () => {
    ...
    const svc = new SpacingSnapService(() => 's.mar: 4\n')
