...
describe('SimpleInsideStrategy', () => {
  ...
  describe('UC-CHILD-04: Empty container always uses index 0', () => {
    it('returns insertionIndex 0 regardless of container size', () => {
      // Small container
      const smallElement = createMockElement(createRect(0, 0, 50, 50), { left: 0, top: 0 })
      ...
      // Large container
      const largeElement = createMockElement(createRect(0, 0, 1000, 1000), { left: 0, top: 0 })
  ...
  describe('getVisualHint()', () => {
    ...
    it('uses containerRect when provided', () => {
      const element = createMockElement(createRect(0, 0, 100, 100), { left: 0, top: 0 })
      const target = createMockFlexTarget({
        element: element as unknown as HTMLElement,
        hasChildren: false,
      })
    ...
    it('falls back to DOM rect when no containerRect or layoutInfo', () => {
      const element = createMockElement(createRect(10, 20, 80, 60), { left: 0, top: 0 })
      const target = createMockFlexTarget({
        element: element as unknown as HTMLElement,
        hasChildren: false,
      })
  ...
  describe('Edge cases', () => {
    it('handles container with zero dimensions', () => {
      const element = createMockElement(createRect(100, 100, 0, 0), { left: 0, top: 0 })
      const target = createMockFlexTarget({
        element: element as unknown as HTMLElement,
        hasChildren: false,
      })
    ...
    it('handles negative container positions', () => {
      const element = createMockElement(createRect(-50, -50, 100, 100), { left: 0, top: 0 })
      const target = createMockFlexTarget({
        element: element as unknown as HTMLElement,
        hasChildren: false,
      })
