...
import { coreTools } from '../../studio/agent/tools/core'
import { writeTools } from '../../studio/agent/tools/write'
import { analyzeTools } from '../../studio/agent/tools/analyze'
import { generateTools } from '../../studio/agent/tools/generate'
