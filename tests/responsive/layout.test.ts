...
export const responsiveLayoutTests: TestCase[] = describe('Responsive Layout', [
  ...
  // jsdom does not evaluate CSS container queries, so offsetWidth stays
  // at its initial flex layout. Browser equivalent covers the visual.
  testWithSetupSkip(
...
runTestCases('Responsive Layout', responsiveLayoutTests)
