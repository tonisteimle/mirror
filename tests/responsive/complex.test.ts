...
export const complexResponsiveTests: TestCase[] = describe('Complex Responsive Patterns', [
  ...
  // jsdom does not evaluate CSS container queries — child widths stay
  // at the initial flex-wrap layout.
  testWithSetupSkip(
...
runTestCases('Complex Responsive Patterns', complexResponsiveTests)
