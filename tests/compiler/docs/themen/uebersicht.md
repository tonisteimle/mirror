...
| 19  | Robustheit (Whitespace, Strings, Kommentare, Fuzz)     | Internals                             | abgeschlossen          | [19-robustness.md](19-robustness.md)                               |
| 20  | Performance / Stress / Skalierbarkeit                  | Internals                             | abgeschlossen          | [20-performance-stress.md](20-performance-stress.md)               |
| 21  | React-Backend (NEU — 0% coverage)                      | Internals                             | abgeschlossen          | [21-react-backend.md](21-react-backend.md)                         |
| 22  | DOM-Backend Cross-Cutting (NEU — `dom.ts`, internals)  | Internals                             | abgeschlossen          | [22-dom-backend-cross-cutting.md](22-dom-backend-cross-cutting.md) |
