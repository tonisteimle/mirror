...
**Tutorial:** `docs/tutorial/04-layout.html` (Kapitel ist groß, Aspekte sind
auf 4 Behavior-Test-Files verteilt).

| Aspekt                          | Test                                           |
| ------------------------------- | ---------------------------------------------- |
| Flex hor/ver                    | `tutorial-05-layout-behavior` Flex Direction   |
| Flex Größen w/h                 | `tutorial-05-layout-behavior` Width & Height   |
| **Device Presets**              | `tutorial-04-layout-aspects` (Iter 2)          |
| Zentrieren center/spread        | `tutorial-05-layout-behavior` Center & Spread  |
| 9 Positionen                    | `tutorial-05-layout-behavior` 9-Zone Alignment |
| Wrap                            | `tutorial-05-layout-behavior` Wrap             |
| Grid aktivieren                 | `tutorial-06-grid-behavior` Grid Basics        |
| Grid Span                       | `tutorial-06-grid-behavior` Grid Span          |
| **Grid als Komponente**         | `tutorial-04-layout-aspects` (Iter 2)          |
| Stacked                         | `tutorial-07-positioning-behavior` Stacked     |
| **Badge auf Icon**              | `tutorial-04-layout-aspects` (Iter 2)          |
| **Eingebaute Size-States**      | `tutorial-04-layout-aspects` (Iter 2)          |
| **Custom Size-State Threshold** | `tutorial-04-layout-aspects` (Iter 2)          |

**Tutorial-Coverage:** 13/13 (100%). Iter 2 schließt 5 Lücken (Device-
Presets, Grid-als-Komponente, Badge-on-Icon, Size-States, Custom-Threshold).
**0 Bugs entdeckt.**
...
- [x] Iter 2: Tutorial-Audit + 7 Aspekt-Tests (Tutorial-Coverage 100%, 0 Bugs)
