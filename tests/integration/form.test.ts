...
export const formIntegrationTests: TestCase[] = describe('Form Integration', [
  // The width assertion (~272px) needs real layout; jsdom returns '100%'
  // instead. Browser stack runs this with real Chrome.
  testWithSetupSkip(
    'Complete login form',
    `FormField: gap 4
...
runTestCases('Form Integration', formIntegrationTests)
