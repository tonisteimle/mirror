/**
 * Conditionals Fixture Runner — Schicht 1 (Golden Files)
 *
 * Reads each subdirectory under tests/fixtures/conditionals/, compiles
...
describe('Conditionals Fixtures (Schicht 1 — Golden Files)', () => {
