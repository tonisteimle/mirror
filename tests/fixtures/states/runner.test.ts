/**
 * States Fixture Runner — Schicht 1 (Golden Files)
 *
 * Reads states subdirectory under tests/fixtures/states/, compiles
...
function normalizeHTML(html: string): string {
  ...
  // Pretty-print: states tag on its own line, indented by depth.
...
describe('States Fixtures (Schicht 1 — Golden Files)', () => {
