/**
 * Each-Loop Fixtures (Schicht 1 — Golden Files) — runner (delegates to shared runSingleFileFixtureCategory).
 *
...
runSingleFileFixtureCategory('Each-Loop Fixtures (Schicht 1 — Golden Files)', __dirname)
