/**
 * Each-Loop Fixture Runner — Schicht 1 (Golden Files)
 *
 * Reads each subdirectory under tests/fixtures/each/, compiles
...
describe('Each-Loop Fixtures (Schicht 1 — Golden Files)', () => {
