/**
 * Tokens Fixture Runner — Schicht 1 (Golden Files)
 *
 * Reads tokens subdirectory under tests/fixtures/tokens/, compiles
...
function normalizeHTML(html: string): string {
  ...
  // Pretty-print: tokens tag on its own line, indented by depth.
...
describe('Tokens Fixtures (Schicht 1 — Golden Files)', () => {
