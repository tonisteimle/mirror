/**
 * Tokens Fixtures (Schicht 1 — Golden Files) — runner (delegates to shared runSingleFileFixtureCategory).
 *
...
runSingleFileFixtureCategory('Tokens Fixtures (Schicht 1 — Golden Files)', __dirname)
