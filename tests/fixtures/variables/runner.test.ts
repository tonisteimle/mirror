/**
 * Variables/Data Fixture Runner — Schicht 1 (Golden Files)
 *
 * Reads each subdirectory under tests/fixtures/variables/, compiles
...
describe('Variables/Data Fixtures (Schicht 1 — Golden Files)', () => {
