  ...
  node_2.innerHTML = formatInlineMarkdown("Only Title")
  ...
  // Footer
  const node_4 = document.createElement('footer')
  _elements['node-4'] = node_4
  node_4.dataset.mirrorId = 'node-4'
  node_4.dataset.mirrorName = 'Footer'
  ...
  node_4.dataset.component = 'Footer'
  node_4.dataset.slot = 'Footer'
