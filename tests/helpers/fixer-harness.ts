...
import type { FixerResponse, FixerChange, FileInfo, AgentEvent, FileType } from '../../studio/agent/types'
...
import { FixerService, createFixer, FixerConfig } from '../../studio/agent/fixer'
