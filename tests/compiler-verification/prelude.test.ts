...
export const noAutoWrapperTests: TestCase[] = describe('No Auto Wrapper', [
  // (Unset-shorthand `padding` resolves differently in jsdom vs Chrome,
  // so the "Frame without padding has no padding" assertion lives in
  // the browser test stack rather than being duplicated here.)
...
runTestCases('No Auto Wrapper', noAutoWrapperTests)
