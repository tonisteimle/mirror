...
$p Properties style a component. Use **bg** for background and **col** for text color:

$code[Button bg #2271c1 "Long form"] or the shorthand $code[Button background #2271c1 "Full name"]'
