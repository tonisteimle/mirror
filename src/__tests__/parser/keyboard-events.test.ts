...
describe('Keyboard Events', () => {
  ...
  onkeydown escape close self`
    ...
    expect(dropdown?.eventHandlers![0].modifier).toBe('escape')
  })
  ...
  onkeydown arrow-down highlight next`
    ...
    expect(menu?.eventHandlers![0].modifier).toBe('arrow-down')
  ...
  onkeydown enter select highlighted`
    ...
    expect(dropdown?.eventHandlers).toHaveLength(1)
    expect(dropdown?.eventHandlers![0].event).toBe('onkeydown')
    expect(dropdown?.eventHandlers![0].modifier).toBe('enter')
  ...
  onkeydown enter select highlighted`
    ...
    expect(menu?.eventHandlers![0].modifier).toBe('arrow-down')
    expect(menu?.eventHandlers![1].modifier).toBe('arrow-up')
    expect(menu?.eventHandlers![2].modifier).toBe('escape')
    expect(menu?.eventHandlers![3].modifier).toBe('enter')
  })
...
events
  ...
  Menu onkeydown arrow-down
    ...
    expect(result.centralizedEvents[0].modifier).toBe('escape')
    expect(result.centralizedEvents[1].event).toBe('onkeydown')
    expect(result.centralizedEvents[1].modifier).toBe('arrow-down')
  })
  ...
  onkeydown end highlight last`
    ...
    expect(list?.eventHandlers![0].modifier).toBe('home')
    expect(list?.eventHandlers![0].actions[0]).toHaveProperty('target', 'first')
    expect(list?.eventHandlers![1].modifier).toBe('end')
