...
:root {
  ...
  [data-mirror-id^="node-8"]:hover {
    background: var(--muted-hover-bg) !important;
    color: var(--text-col) !important;
  }
  
  [data-mirror-id^="node-38"]:hover {
    background: var(--card-hover-bg) !important;
  }
  
  [data-mirror-id^="node-47"]:hover {
    background: var(--card-hover-bg) !important;
  }
  
  [data-mirror-id^="node-52"]:hover {
    background: var(--card-hover-bg) !important;
  }
  
  [data-mirror-id^="node-57"]:hover {
    background: var(--card-hover-bg) !important;
  }
  ...
  [data-mirror-id^="node-67"]:focus {
    border-color: $accent !important;
  }
  
  [data-mirror-id^="node-79"]:hover {
  ...
  node_4.dataset.mirrorName = 'PageTitle'
  node_4.textContent = 'Zeiterfassung'
  Object.assign(node_4.style, {
    color: 'var(--text-col)',
    'font-size': 'var(--fs-xl-fs)',
    'font-weight': '600',
  })
  node_4.dataset.component = 'PageTitle'
  ...
  node_5.dataset.mirrorName = 'PageSubtitle'
  node_5.textContent = 'April 2026'
  Object.assign(node_5.style, {
    color: 'var(--text-secondary-col)',
    'font-size': 'var(--fs-md-fs)',
  })
  node_5.dataset.component = 'PageSubtitle'
  ...
  node_6.dataset.mirrorName = 'Spacer'
  ...
  node_6.dataset.component = 'Spacer'
  ...
  node_7.dataset.layout = 'flex'
  node_7.dataset.component = 'Frame'
  // BtnSecondary
  const node_8 = document.createElement('button')
  _elements['node-8'] = node_8
  node_8.dataset.mirrorId = 'node-8'
  node_8.dataset.mirrorName = 'BtnSecondary'
  node_8.textContent = 'Export'
  ...
  node_8.dataset.component = 'BtnSecondary'
  ...
  node_9.dataset.zagComponent = 'dialog'
  node_9.style.display = 'inline-block'
  node_9.dataset.mirrorName = 'Dialog'
  node_9._zagConfig = {
    type: 'dialog',
    id: 'node-9',
    machineConfig: { id: 'node-9' },
  }

  // Trigger
  const node_9_trigger = document.createElement('span')
  node_9_trigger.style.display = 'inline-block'
  node_9_trigger.dataset.slot = 'Trigger'
  node_9_trigger.setAttribute('aria-haspopup', 'dialog')
  // BtnPrimary
  const node_10 = document.createElement('button')
  _elements['node-10'] = node_10
  node_10.dataset.mirrorId = 'node-10'
  node_10.dataset.mirrorName = 'BtnPrimary'
  node_10.textContent = 'Neuer Eintrag'
  ...
  node_10.dataset.component = 'BtnPrimary'
  node_9_trigger.appendChild(node_10)

  node_9.appendChild(node_9_trigger)

  // Backdrop
  const node_9_backdrop = document.createElement('div')
  node_9_backdrop.dataset.slot = 'Backdrop'
  node_9.appendChild(node_9_backdrop)

  // Content (modal)
  const node_9_content = document.createElement('div')
  node_9_content.dataset.slot = 'Content'
  node_9_content.setAttribute('role', 'dialog')
  node_9_content.setAttribute('aria-modal', 'true')
  ...
  Object.assign(node_12.style, {
    ...
    padding: '0px 0px var(--gap-xl-pad) 0px',
  })
  ...
  node_17.dataset.mirrorName = 'FormField'
  ...
  node_17.dataset.component = 'FormField'
  // Label
  const node_18 = document.createElement('label')
  _elements['node-18'] = node_18
  node_18.dataset.mirrorId = 'node-18'
  node_18.dataset.mirrorName = 'Label'
  node_18.textContent = 'Datum'
  Object.assign(node_18.style, {
    color: 'var(--text-secondary-col)',
    'font-size': 'var(--fs-sm-fs)',
  })
  node_18.dataset.component = 'Label'
  node_18.dataset.slot = 'Label'
  node_17.appendChild(node_18)

  // FormInput
  const node_19 = document.createElement('input')
  _elements['node-19'] = node_19
  node_19.dataset.mirrorId = 'node-19'
  node_19.dataset.mirrorName = 'FormInput'
  ...
  node_19.dataset.bind = 'newDate'
  node_19.dataset.component = 'FormInput'
  // Two-way data binding: newDate
  node_19.value = $get('newDate') ?? ''
  node_19.addEventListener('input', e => {
    $set('newDate', e.target.value)
  })
  _runtime.bindValue(node_19, 'newDate')
  ...
  node_20.dataset.mirrorName = 'FormField'
  ...
  node_20.dataset.component = 'FormField'
  // Label
  const node_21 = document.createElement('label')
  _elements['node-21'] = node_21
  node_21.dataset.mirrorId = 'node-21'
  node_21.dataset.mirrorName = 'Label'
  node_21.textContent = 'Projekt'
  Object.assign(node_21.style, {
    color: 'var(--text-secondary-col)',
    'font-size': 'var(--fs-sm-fs)',
  })
  node_21.dataset.component = 'Label'
  node_21.dataset.slot = 'Label'
  ...
  node_22.dataset.zagComponent = 'select'
  node_22.dataset.mirrorName = 'Select'
  node_22.dataset.bind = 'newProject'
  node_22._zagConfig = {
    type: 'select',
    id: 'node-22',
    machineConfig: { id: 'node-22', placeholder: 'Projekt wählen...' },
    items: [
  ...
  // Trigger
  const node_22_trigger = document.createElement('button')
  node_22_trigger.type = 'button'
  node_22_trigger.dataset.slot = 'Trigger'
  node_22_trigger.setAttribute('role', 'combobox')
  node_22_trigger.setAttribute('aria-haspopup', 'listbox')
  node_22_trigger.setAttribute('aria-expanded', 'false')
  const node_22_trigger_text = document.createElement('span')
  node_22_trigger_text.dataset.slot = 'TriggerText'
  node_22_trigger_text.textContent = 'Projekt wählen...'
  node_22_trigger.appendChild(node_22_trigger_text)
  const node_22_trigger_arrow = document.createElement('span')
  node_22_trigger_arrow.dataset.slot = 'TriggerArrow'
  node_22_trigger_arrow.dataset.icon = 'chevron-down'
  node_22_trigger.appendChild(node_22_trigger_arrow)
  node_22.appendChild(node_22_trigger)

  // Content (dropdown)
  const node_22_content = document.createElement('div')
  node_22_content.dataset.slot = 'Content'
  node_22_content.setAttribute('role', 'listbox')

  // Item: Website Relaunch
  const node_22_item0 = document.createElement('div')
  node_22_item0.dataset.slot = 'Item'
  node_22_item0.dataset.value = 'Website Relaunch'
  node_22_item0.setAttribute('role', 'option')
  node_22_item0.dataset.icon = 'check'
  const node_22_item0_text = document.createElement('span')
  node_22_item0_text.dataset.slot = 'ItemText'
  node_22_item0_text.textContent = 'Website Relaunch'
  node_22_item0.appendChild(node_22_item0_text)
  const node_22_item0_indicator = document.createElement('span')
  node_22_item0_indicator.dataset.slot = 'ItemIndicator'
  node_22_item0.appendChild(node_22_item0_indicator)
  node_22_content.appendChild(node_22_item0)

  // Item: Mobile App
  const node_22_item1 = document.createElement('div')
  node_22_item1.dataset.slot = 'Item'
  node_22_item1.dataset.value = 'Mobile App'
  node_22_item1.setAttribute('role', 'option')
  node_22_item1.dataset.icon = 'check'
  const node_22_item1_text = document.createElement('span')
  node_22_item1_text.dataset.slot = 'ItemText'
  node_22_item1_text.textContent = 'Mobile App'
  node_22_item1.appendChild(node_22_item1_text)
  const node_22_item1_indicator = document.createElement('span')
  node_22_item1_indicator.dataset.slot = 'ItemIndicator'
  node_22_item1.appendChild(node_22_item1_indicator)
  node_22_content.appendChild(node_22_item1)

  // Item: Intern
  const node_22_item2 = document.createElement('div')
  node_22_item2.dataset.slot = 'Item'
  node_22_item2.dataset.value = 'Intern'
  node_22_item2.setAttribute('role', 'option')
  node_22_item2.dataset.icon = 'check'
  const node_22_item2_text = document.createElement('span')
  node_22_item2_text.dataset.slot = 'ItemText'
  node_22_item2_text.textContent = 'Intern'
  node_22_item2.appendChild(node_22_item2_text)
  const node_22_item2_indicator = document.createElement('span')
  node_22_item2_indicator.dataset.slot = 'ItemIndicator'
  node_22_item2.appendChild(node_22_item2_indicator)
  node_22_content.appendChild(node_22_item2)

  // Item: Support
  const node_22_item3 = document.createElement('div')
  node_22_item3.dataset.slot = 'Item'
  node_22_item3.dataset.value = 'Support'
  node_22_item3.setAttribute('role', 'option')
  node_22_item3.dataset.icon = 'check'
  const node_22_item3_text = document.createElement('span')
  node_22_item3_text.dataset.slot = 'ItemText'
  node_22_item3_text.textContent = 'Support'
  node_22_item3.appendChild(node_22_item3_text)
  const node_22_item3_indicator = document.createElement('span')
  node_22_item3_indicator.dataset.slot = 'ItemIndicator'
  node_22_item3.appendChild(node_22_item3_indicator)
  node_22_content.appendChild(node_22_item3)

  node_22.appendChild(node_22_content)
  node_20.appendChild(node_22)

  // Initialize Select
  if (typeof _runtime !== 'undefined' && _runtime.initSelectComponent) {
    _runtime.initSelectComponent(node_22)
  }
  ...
  node_23.dataset.mirrorName = 'FormField'
  ...
  node_23.dataset.component = 'FormField'
  // Label
  const node_24 = document.createElement('label')
  _elements['node-24'] = node_24
  node_24.dataset.mirrorId = 'node-24'
  node_24.dataset.mirrorName = 'Label'
  node_24.textContent = 'Kunde'
  Object.assign(node_24.style, {
    color: 'var(--text-secondary-col)',
    'font-size': 'var(--fs-sm-fs)',
  })
  node_24.dataset.component = 'Label'
  node_24.dataset.slot = 'Label'
  ...
  node_25.dataset.zagComponent = 'select'
  node_25.dataset.mirrorName = 'Select'
  node_25.dataset.bind = 'newClient'
  node_25._zagConfig = {
    type: 'select',
    id: 'node-25',
    machineConfig: { id: 'node-25', placeholder: 'Kunde wählen...' },
    items: [
  ...
  // Trigger
  const node_25_trigger = document.createElement('button')
  node_25_trigger.type = 'button'
  node_25_trigger.dataset.slot = 'Trigger'
  node_25_trigger.setAttribute('role', 'combobox')
  node_25_trigger.setAttribute('aria-haspopup', 'listbox')
  node_25_trigger.setAttribute('aria-expanded', 'false')
  const node_25_trigger_text = document.createElement('span')
  node_25_trigger_text.dataset.slot = 'TriggerText'
  node_25_trigger_text.textContent = 'Kunde wählen...'
  node_25_trigger.appendChild(node_25_trigger_text)
  const node_25_trigger_arrow = document.createElement('span')
  node_25_trigger_arrow.dataset.slot = 'TriggerArrow'
  node_25_trigger_arrow.dataset.icon = 'chevron-down'
  node_25_trigger.appendChild(node_25_trigger_arrow)
  node_25.appendChild(node_25_trigger)

  // Content (dropdown)
  const node_25_content = document.createElement('div')
  node_25_content.dataset.slot = 'Content'
  node_25_content.setAttribute('role', 'listbox')

  // Item: Müller AG
  const node_25_item0 = document.createElement('div')
  node_25_item0.dataset.slot = 'Item'
  node_25_item0.dataset.value = 'Müller AG'
  node_25_item0.setAttribute('role', 'option')
  node_25_item0.dataset.icon = 'check'
  const node_25_item0_text = document.createElement('span')
  node_25_item0_text.dataset.slot = 'ItemText'
  node_25_item0_text.textContent = 'Müller AG'
  node_25_item0.appendChild(node_25_item0_text)
  const node_25_item0_indicator = document.createElement('span')
  node_25_item0_indicator.dataset.slot = 'ItemIndicator'
  node_25_item0.appendChild(node_25_item0_indicator)
  node_25_content.appendChild(node_25_item0)

  // Item: Schmidt GmbH
  const node_25_item1 = document.createElement('div')
  node_25_item1.dataset.slot = 'Item'
  node_25_item1.dataset.value = 'Schmidt GmbH'
  node_25_item1.setAttribute('role', 'option')
  node_25_item1.dataset.icon = 'check'
  const node_25_item1_text = document.createElement('span')
  node_25_item1_text.dataset.slot = 'ItemText'
  node_25_item1_text.textContent = 'Schmidt GmbH'
  node_25_item1.appendChild(node_25_item1_text)
  const node_25_item1_indicator = document.createElement('span')
  node_25_item1_indicator.dataset.slot = 'ItemIndicator'
  node_25_item1.appendChild(node_25_item1_indicator)
  node_25_content.appendChild(node_25_item1)

  // Item: Weber & Co
  const node_25_item2 = document.createElement('div')
  node_25_item2.dataset.slot = 'Item'
  node_25_item2.dataset.value = 'Weber & Co'
  node_25_item2.setAttribute('role', 'option')
  node_25_item2.dataset.icon = 'check'
  const node_25_item2_text = document.createElement('span')
  node_25_item2_text.dataset.slot = 'ItemText'
  node_25_item2_text.textContent = 'Weber & Co'
  node_25_item2.appendChild(node_25_item2_text)
  const node_25_item2_indicator = document.createElement('span')
  node_25_item2_indicator.dataset.slot = 'ItemIndicator'
  node_25_item2.appendChild(node_25_item2_indicator)
  node_25_content.appendChild(node_25_item2)

  // Item: —
  const node_25_item3 = document.createElement('div')
  node_25_item3.dataset.slot = 'Item'
  node_25_item3.dataset.value = '—'
  node_25_item3.setAttribute('role', 'option')
  node_25_item3.dataset.icon = 'check'
  const node_25_item3_text = document.createElement('span')
  node_25_item3_text.dataset.slot = 'ItemText'
  node_25_item3_text.textContent = '—'
  node_25_item3.appendChild(node_25_item3_text)
  const node_25_item3_indicator = document.createElement('span')
  node_25_item3_indicator.dataset.slot = 'ItemIndicator'
  node_25_item3.appendChild(node_25_item3_indicator)
  node_25_content.appendChild(node_25_item3)

  node_25.appendChild(node_25_content)
  node_23.appendChild(node_25)

  // Initialize Select
  if (typeof _runtime !== 'undefined' && _runtime.initSelectComponent) {
    _runtime.initSelectComponent(node_25)
  }
  ...
  node_26.dataset.mirrorName = 'FormField'
  ...
  node_26.dataset.component = 'FormField'
  // Label
  const node_27 = document.createElement('label')
  _elements['node-27'] = node_27
  node_27.dataset.mirrorId = 'node-27'
  node_27.dataset.mirrorName = 'Label'
  node_27.textContent = 'Tätigkeit'
  Object.assign(node_27.style, {
    color: 'var(--text-secondary-col)',
    'font-size': 'var(--fs-sm-fs)',
  })
  node_27.dataset.component = 'Label'
  node_27.dataset.slot = 'Label'
  node_26.appendChild(node_27)

  // FormInput
  const node_28 = document.createElement('input')
  _elements['node-28'] = node_28
  node_28.dataset.mirrorId = 'node-28'
  node_28.dataset.mirrorName = 'FormInput'
  node_28.setAttribute('placeholder', 'Was wurde gemacht?')
  ...
  node_28.dataset.bind = 'newTask'
  node_28.dataset.component = 'FormInput'
  // Two-way data binding: newTask
  node_28.value = $get('newTask') ?? ''
  node_28.addEventListener('input', e => {
    $set('newTask', e.target.value)
  })
  _runtime.bindValue(node_28, 'newTask')
  ...
  node_29.dataset.mirrorName = 'FormField'
  ...
  node_29.dataset.component = 'FormField'
  // Label
  const node_30 = document.createElement('label')
  _elements['node-30'] = node_30
  node_30.dataset.mirrorId = 'node-30'
  node_30.dataset.mirrorName = 'Label'
  node_30.textContent = 'Stunden'
  Object.assign(node_30.style, {
    color: 'var(--text-secondary-col)',
    'font-size': 'var(--fs-sm-fs)',
  })
  node_30.dataset.component = 'Label'
  node_30.dataset.slot = 'Label'
  node_29.appendChild(node_30)

  // FormInput
  const node_31 = document.createElement('input')
  _elements['node-31'] = node_31
  node_31.dataset.mirrorId = 'node-31'
  node_31.dataset.mirrorName = 'FormInput'
  node_31.setAttribute('type', 'number')
  ...
  node_31.dataset.bind = 'newHours'
  node_31.dataset.component = 'FormInput'
  // Two-way data binding: newHours
  node_31.value = $get('newHours') ?? ''
  node_31.addEventListener('input', e => {
    $set('newHours', e.target.value)
  })
  _runtime.bindValue(node_31, 'newHours')
  node_29.appendChild(node_31)

  node_16.appendChild(node_29)

  // Checkbox Component
  const node_32 = document.createElement('label')
  _elements['node-32'] = node_32
  node_32.dataset.mirrorId = 'node-32'
  node_32.dataset.zagComponent = 'checkbox'
  node_32.dataset.mirrorName = 'Checkbox'
  node_32._zagConfig = {
    type: 'checkbox',
    id: 'node-32',
    machineConfig: { id: 'node-32', checked: true },
  }

  // HiddenInput (form submission)
  const node_32_hiddenInput = document.createElement('input')
  node_32_hiddenInput.type = 'checkbox'
  node_32_hiddenInput.dataset.slot = 'HiddenInput'
  node_32_hiddenInput.style.position = 'absolute'
  node_32_hiddenInput.style.width = '1px'
  node_32_hiddenInput.style.height = '1px'
  node_32_hiddenInput.style.padding = '0'
  node_32_hiddenInput.style.margin = '-1px'
  node_32_hiddenInput.style.overflow = 'hidden'
  node_32_hiddenInput.style.clip = 'rect(0, 0, 0, 0)'
  node_32_hiddenInput.style.whiteSpace = 'nowrap'
  node_32_hiddenInput.style.border = '0'
  node_32.appendChild(node_32_hiddenInput)

  // Control (visual checkbox)
  const node_32_control = document.createElement('div')
  node_32_control.dataset.slot = 'Control'
  node_32.appendChild(node_32_control)

  // Indicator (checkmark)
  const node_32_indicator = document.createElement('span')
  node_32_indicator.dataset.slot = 'Indicator'
  node_32_indicator.dataset.icon = 'check'
  node_32_control.appendChild(node_32_indicator)

  node_16.appendChild(node_32)

  // Initialize Checkbox
  if (typeof _runtime !== 'undefined' && _runtime.initCheckboxComponent) {
    _runtime.initCheckboxComponent(node_32)
  }
  ...
  Object.assign(node_33.style, {
    ...
    'border-color': 'var(--border-boc)',
    padding: 'var(--gap-xl-pad) 0px 0px 0px',
  })
  ...
  node_36.dataset.mirrorName = 'BtnPrimary'
  node_36.textContent = 'Speichern'
  ...
  node_36.dataset.component = 'BtnPrimary'
  node_36.addEventListener('click', e => {
    _runtime.add('entries', {
      date: $get('newDate'),
      project: $get('newProject'),
      client: $get('newClient'),
      task: $get('newTask'),
      hours: $get('newHours'),
      billable: $get('newBillable'),
    })
  })
  node_33.appendChild(node_36)

  node_11.appendChild(node_33)
  ...
  if (typeof _runtime !== 'undefined' && _runtime.initDialogComponent) {
    _runtime.initDialogComponent(node_9)
  }
  ...
  node_38.dataset.mirrorName = 'StatCard'
  ...
  node_38.dataset.component = 'StatCard'
  // Label
  const node_39 = document.createElement('label')
  _elements['node-39'] = node_39
  node_39.dataset.mirrorId = 'node-39'
  node_39.dataset.mirrorName = 'Label'
  node_39.textContent = 'Stunden Monat'
  Object.assign(node_39.style, {
    color: 'var(--text-muted-col)',
    'font-size': 'var(--fs-sm-fs)',
    'text-transform': 'uppercase',
  })
  node_39.dataset.component = 'Label'
  node_39.dataset.slot = 'Label'
  ...
  node_40.dataset.mirrorName = 'Value'
  node_40.textContent = '168.5'
  ...
  node_40.dataset.component = 'Value'
  ...
  node_41.dataset.mirrorName = 'Sub'
  ...
  node_42.dataset.component = 'SubSuccess'
  node_38.appendChild(node_42)
  ...
  node_46.dataset.mirrorName = 'Sub'
  node_46.textContent = 'von 176h'
  ...
  node_46.dataset.component = 'Sub'
  node_43.appendChild(node_46)

  node_38.appendChild(node_43)
  ...
  node_47.dataset.mirrorName = 'StatCard'
  ...
  node_47.dataset.component = 'StatCard'
  // Label
  const node_48 = document.createElement('label')
  _elements['node-48'] = node_48
  node_48.dataset.mirrorId = 'node-48'
  node_48.dataset.mirrorName = 'Label'
  node_48.textContent = 'Überstunden'
  Object.assign(node_48.style, {
    color: 'var(--text-muted-col)',
    'font-size': 'var(--fs-sm-fs)',
    'text-transform': 'uppercase',
  })
  node_48.dataset.component = 'Label'
  node_48.dataset.slot = 'Label'
  ...
  node_49.dataset.mirrorName = 'Value'
  node_49.textContent = '+12.5'
  ...
  node_49.dataset.component = 'Value'
  ...
  node_50.dataset.mirrorName = 'SubSuccess'
  node_50.textContent = 'kumuliert'
  ...
  node_50.dataset.component = 'SubSuccess'
  ...
  node_51.dataset.mirrorName = 'Sub'
  ...
  node_52.dataset.component = 'StatCard'
  // Label
  const node_53 = document.createElement('label')
  _elements['node-53'] = node_53
  node_53.dataset.mirrorId = 'node-53'
  node_53.dataset.mirrorName = 'Label'
  node_53.textContent = 'Resturlaub'
  Object.assign(node_53.style, {
    color: 'var(--text-muted-col)',
    'font-size': 'var(--fs-sm-fs)',
    'text-transform': 'uppercase',
  })
  node_53.dataset.component = 'Label'
  node_53.dataset.slot = 'Label'
  ...
  node_54.dataset.mirrorName = 'Value'
  node_54.textContent = '11'
  ...
  node_54.dataset.component = 'Value'
  ...
  node_55.textContent = 'von 18 Tagen'
  ...
  node_56.dataset.component = 'SubSuccess'
  node_52.appendChild(node_56)

  node_37.appendChild(node_52)

  // StatCard
  const node_57 = document.createElement('div')
  _elements['node-57'] = node_57
  node_57.dataset.mirrorId = 'node-57'
  node_57.dataset.mirrorName = 'StatCard'
  ...
  node_57.dataset.component = 'StatCard'
  // Label
  const node_58 = document.createElement('label')
  _elements['node-58'] = node_58
  node_58.dataset.mirrorId = 'node-58'
  node_58.dataset.mirrorName = 'Label'
  node_58.textContent = 'Verrechenbar'
  Object.assign(node_58.style, {
    color: 'var(--text-muted-col)',
    'font-size': 'var(--fs-sm-fs)',
    'text-transform': 'uppercase',
  })
  node_58.dataset.component = 'Label'
  node_58.dataset.slot = 'Label'
  ...
  node_59.dataset.mirrorName = 'Value'
  node_59.textContent = '89%'
  ...
  node_59.dataset.component = 'Value'
  ...
  node_61.dataset.mirrorName = 'Sub'
  ...
  node_61.dataset.component = 'Sub'
  node_57.appendChild(node_61)

  node_37.appendChild(node_57)

  node_1.appendChild(node_37)
  ...
  node_63.dataset.mirrorName = 'SectionLabel'
  node_63.textContent = 'Filter:'
  ...
  node_63.dataset.component = 'SectionLabel'
  ...
  node_64.dataset.zagComponent = 'select'
  node_64.dataset.mirrorName = 'Select'
  node_64.dataset.bind = 'filterProject'
  node_64._zagConfig = {
    type: 'select',
    id: 'node-64',
    machineConfig: { id: 'node-64', placeholder: 'Alle Projekte' },
    items: [
  ...
  // Trigger
  const node_64_trigger = document.createElement('button')
  node_64_trigger.type = 'button'
  node_64_trigger.dataset.slot = 'Trigger'
  node_64_trigger.setAttribute('role', 'combobox')
  node_64_trigger.setAttribute('aria-haspopup', 'listbox')
  node_64_trigger.setAttribute('aria-expanded', 'false')
  const node_64_trigger_text = document.createElement('span')
  node_64_trigger_text.dataset.slot = 'TriggerText'
  node_64_trigger_text.textContent = 'Alle Projekte'
  node_64_trigger.appendChild(node_64_trigger_text)
  const node_64_trigger_arrow = document.createElement('span')
  node_64_trigger_arrow.dataset.slot = 'TriggerArrow'
  node_64_trigger_arrow.dataset.icon = 'chevron-down'
  node_64_trigger.appendChild(node_64_trigger_arrow)
  node_64.appendChild(node_64_trigger)

  // Content (dropdown)
  const node_64_content = document.createElement('div')
  node_64_content.dataset.slot = 'Content'
  node_64_content.setAttribute('role', 'listbox')

  // Item: Alle Projekte
  const node_64_item0 = document.createElement('div')
  node_64_item0.dataset.slot = 'Item'
  node_64_item0.dataset.value = ''
  node_64_item0.setAttribute('role', 'option')
  node_64_item0.dataset.icon = 'check'
  const node_64_item0_text = document.createElement('span')
  node_64_item0_text.dataset.slot = 'ItemText'
  node_64_item0_text.textContent = 'Alle Projekte'
  node_64_item0.appendChild(node_64_item0_text)
  const node_64_item0_indicator = document.createElement('span')
  node_64_item0_indicator.dataset.slot = 'ItemIndicator'
  node_64_item0.appendChild(node_64_item0_indicator)
  node_64_content.appendChild(node_64_item0)

  // Item: Website Relaunch
  const node_64_item1 = document.createElement('div')
  node_64_item1.dataset.slot = 'Item'
  node_64_item1.dataset.value = 'Website Relaunch'
  node_64_item1.setAttribute('role', 'option')
  node_64_item1.dataset.icon = 'check'
  const node_64_item1_text = document.createElement('span')
  node_64_item1_text.dataset.slot = 'ItemText'
  node_64_item1_text.textContent = 'Website Relaunch'
  node_64_item1.appendChild(node_64_item1_text)
  const node_64_item1_indicator = document.createElement('span')
  node_64_item1_indicator.dataset.slot = 'ItemIndicator'
  node_64_item1.appendChild(node_64_item1_indicator)
  node_64_content.appendChild(node_64_item1)

  // Item: Mobile App
  const node_64_item2 = document.createElement('div')
  node_64_item2.dataset.slot = 'Item'
  node_64_item2.dataset.value = 'Mobile App'
  node_64_item2.setAttribute('role', 'option')
  node_64_item2.dataset.icon = 'check'
  const node_64_item2_text = document.createElement('span')
  node_64_item2_text.dataset.slot = 'ItemText'
  node_64_item2_text.textContent = 'Mobile App'
  node_64_item2.appendChild(node_64_item2_text)
  const node_64_item2_indicator = document.createElement('span')
  node_64_item2_indicator.dataset.slot = 'ItemIndicator'
  node_64_item2.appendChild(node_64_item2_indicator)
  node_64_content.appendChild(node_64_item2)

  // Item: Intern
  const node_64_item3 = document.createElement('div')
  node_64_item3.dataset.slot = 'Item'
  node_64_item3.dataset.value = 'Intern'
  node_64_item3.setAttribute('role', 'option')
  node_64_item3.dataset.icon = 'check'
  const node_64_item3_text = document.createElement('span')
  node_64_item3_text.dataset.slot = 'ItemText'
  node_64_item3_text.textContent = 'Intern'
  node_64_item3.appendChild(node_64_item3_text)
  const node_64_item3_indicator = document.createElement('span')
  node_64_item3_indicator.dataset.slot = 'ItemIndicator'
  node_64_item3.appendChild(node_64_item3_indicator)
  node_64_content.appendChild(node_64_item3)

  // Item: Support
  const node_64_item4 = document.createElement('div')
  node_64_item4.dataset.slot = 'Item'
  node_64_item4.dataset.value = 'Support'
  node_64_item4.setAttribute('role', 'option')
  node_64_item4.dataset.icon = 'check'
  const node_64_item4_text = document.createElement('span')
  node_64_item4_text.dataset.slot = 'ItemText'
  node_64_item4_text.textContent = 'Support'
  node_64_item4.appendChild(node_64_item4_text)
  const node_64_item4_indicator = document.createElement('span')
  node_64_item4_indicator.dataset.slot = 'ItemIndicator'
  node_64_item4.appendChild(node_64_item4_indicator)
  node_64_content.appendChild(node_64_item4)

  node_64.appendChild(node_64_content)
  node_62.appendChild(node_64)

  // Initialize Select
  if (typeof _runtime !== 'undefined' && _runtime.initSelectComponent) {
    _runtime.initSelectComponent(node_64)
  }
  ...
  node_65.dataset.zagComponent = 'select'
  node_65.dataset.mirrorName = 'Select'
  node_65.dataset.bind = 'filterClient'
  node_65._zagConfig = {
    type: 'select',
    id: 'node-65',
    machineConfig: { id: 'node-65', placeholder: 'Alle Kunden' },
    items: [
  ...
  // Trigger
  const node_65_trigger = document.createElement('button')
  node_65_trigger.type = 'button'
  node_65_trigger.dataset.slot = 'Trigger'
  node_65_trigger.setAttribute('role', 'combobox')
  node_65_trigger.setAttribute('aria-haspopup', 'listbox')
  node_65_trigger.setAttribute('aria-expanded', 'false')
  const node_65_trigger_text = document.createElement('span')
  node_65_trigger_text.dataset.slot = 'TriggerText'
  node_65_trigger_text.textContent = 'Alle Kunden'
  node_65_trigger.appendChild(node_65_trigger_text)
  const node_65_trigger_arrow = document.createElement('span')
  node_65_trigger_arrow.dataset.slot = 'TriggerArrow'
  node_65_trigger_arrow.dataset.icon = 'chevron-down'
  node_65_trigger.appendChild(node_65_trigger_arrow)
  node_65.appendChild(node_65_trigger)

  // Content (dropdown)
  const node_65_content = document.createElement('div')
  node_65_content.dataset.slot = 'Content'
  node_65_content.setAttribute('role', 'listbox')

  // Item: Alle Kunden
  const node_65_item0 = document.createElement('div')
  node_65_item0.dataset.slot = 'Item'
  node_65_item0.dataset.value = ''
  node_65_item0.setAttribute('role', 'option')
  node_65_item0.dataset.icon = 'check'
  const node_65_item0_text = document.createElement('span')
  node_65_item0_text.dataset.slot = 'ItemText'
  node_65_item0_text.textContent = 'Alle Kunden'
  node_65_item0.appendChild(node_65_item0_text)
  const node_65_item0_indicator = document.createElement('span')
  node_65_item0_indicator.dataset.slot = 'ItemIndicator'
  node_65_item0.appendChild(node_65_item0_indicator)
  node_65_content.appendChild(node_65_item0)

  // Item: Müller AG
  const node_65_item1 = document.createElement('div')
  node_65_item1.dataset.slot = 'Item'
  node_65_item1.dataset.value = 'Müller AG'
  node_65_item1.setAttribute('role', 'option')
  node_65_item1.dataset.icon = 'check'
  const node_65_item1_text = document.createElement('span')
  node_65_item1_text.dataset.slot = 'ItemText'
  node_65_item1_text.textContent = 'Müller AG'
  node_65_item1.appendChild(node_65_item1_text)
  const node_65_item1_indicator = document.createElement('span')
  node_65_item1_indicator.dataset.slot = 'ItemIndicator'
  node_65_item1.appendChild(node_65_item1_indicator)
  node_65_content.appendChild(node_65_item1)

  // Item: Schmidt GmbH
  const node_65_item2 = document.createElement('div')
  node_65_item2.dataset.slot = 'Item'
  node_65_item2.dataset.value = 'Schmidt GmbH'
  node_65_item2.setAttribute('role', 'option')
  node_65_item2.dataset.icon = 'check'
  const node_65_item2_text = document.createElement('span')
  node_65_item2_text.dataset.slot = 'ItemText'
  node_65_item2_text.textContent = 'Schmidt GmbH'
  node_65_item2.appendChild(node_65_item2_text)
  const node_65_item2_indicator = document.createElement('span')
  node_65_item2_indicator.dataset.slot = 'ItemIndicator'
  node_65_item2.appendChild(node_65_item2_indicator)
  node_65_content.appendChild(node_65_item2)

  // Item: Weber & Co
  const node_65_item3 = document.createElement('div')
  node_65_item3.dataset.slot = 'Item'
  node_65_item3.dataset.value = 'Weber & Co'
  node_65_item3.setAttribute('role', 'option')
  node_65_item3.dataset.icon = 'check'
  const node_65_item3_text = document.createElement('span')
  node_65_item3_text.dataset.slot = 'ItemText'
  node_65_item3_text.textContent = 'Weber & Co'
  node_65_item3.appendChild(node_65_item3_text)
  const node_65_item3_indicator = document.createElement('span')
  node_65_item3_indicator.dataset.slot = 'ItemIndicator'
  node_65_item3.appendChild(node_65_item3_indicator)
  node_65_content.appendChild(node_65_item3)

  node_65.appendChild(node_65_content)
  node_62.appendChild(node_65)

  // Initialize Select
  if (typeof _runtime !== 'undefined' && _runtime.initSelectComponent) {
    _runtime.initSelectComponent(node_65)
  }
  ...
  node_66.dataset.mirrorName = 'Spacer'
  ...
  node_66.dataset.component = 'Spacer'
  node_62.appendChild(node_66)

  // SearchInput
  const node_67 = document.createElement('input')
  _elements['node-67'] = node_67
  node_67.dataset.mirrorId = 'node-67'
  node_67.dataset.mirrorName = 'SearchInput'
  node_67.setAttribute('placeholder', 'Suchen...')
  ...
  node_67.dataset.bind = 'searchQuery'
  node_67.dataset.component = 'SearchInput'
  // Two-way data binding: searchQuery
  node_67.value = $get('searchQuery') ?? ''
  node_67.addEventListener('input', e => {
    $set('searchQuery', e.target.value)
  })
  _runtime.bindValue(node_67, 'searchQuery')
  node_62.appendChild(node_67)

  node_1.appendChild(node_62)

  // Frame
  const node_68 = document.createElement('div')
  _elements['node-68'] = node_68
  node_68.dataset.mirrorId = 'node-68'
  node_68.dataset.mirrorName = 'Frame'
  ...
  node_69.dataset.component = 'TableHeader'
  // HeaderCell
  const node_70 = document.createElement('span')
  _elements['node-70'] = node_70
  node_70.dataset.mirrorId = 'node-70'
  node_70.dataset.mirrorName = 'HeaderCell'
  node_70.textContent = 'Datum'
  ...
  node_70.dataset.component = 'HeaderCell'
  ...
  node_71.dataset.mirrorName = 'HeaderCell'
  node_71.textContent = 'Projekt'
  ...
  node_71.dataset.component = 'HeaderCell'
  ...
  node_72.dataset.mirrorName = 'HeaderCell'
  node_72.textContent = 'Kunde'
  ...
  node_72.dataset.component = 'HeaderCell'
  ...
  node_73.dataset.mirrorName = 'HeaderCell'
  node_73.textContent = 'Tätigkeit'
  ...
  node_73.dataset.component = 'HeaderCell'
  ...
  node_75.dataset.component = 'Frame'
  // Icon
  ...
  node_76.setAttribute('data-icon-color', 'var(--text-muted-ic)')
  node_76.setAttribute('data-icon-size', 'var(--icon-sm-is)')
  // Icon default styles
  ...
  // Load Lucide icon
  _runtime.loadIcon(node_76, 'receipt')
  Object.assign(node_76.style, {
    width: '20px',
    'flex-shrink': '0',
    height: '20px',
  ...
  const node_78_container = document.createElement('div')
  node_78_container.dataset.eachContainer = 'node-78'
  node_78_container.style.display = 'contents'

  _elements['node-78'] = node_78_container
  node_78_container._eachConfig = {
    itemVar: 'entry',
    collection: 'entries',
    filterFn: entry =>
      ($get('filterProject') == '' || entry.project == $get('filterProject')) &&
      ($get('filterClient') == '' || entry.client == $get('filterClient')) &&
      ($get('searchQuery') == '' ||
        entry.task.toLowerCase().includes($get('searchQuery').toLowerCase()) ||
    ...
    renderItem: (entry, index) => {
      ...
      const node_79_tpl = document.createElement('div')
      node_79_tpl.dataset.mirrorId = 'node-79[' + index + ']'
      node_79_tpl._loopItem = entry
      node_79_tpl.dataset.mirrorName = 'TableRow'
      Object.assign(node_79_tpl.style, {
        display: 'flex',
        'flex-direction': 'row',
        'align-self': 'stretch',
        'align-items': 'center',
        gap: 'var(--gap-md-gap)',
        padding: '8px var(--space-md-pad)',
        'border-style': 'solid',
      ...
      const node_80_tpl = document.createElement('span')
      node_80_tpl.dataset.mirrorId = 'node-80[' + index + ']'
      node_80_tpl._loopItem = entry
      node_80_tpl.dataset.mirrorName = 'CellDate'
      node_80_tpl.textContent = entry.date
      Object.assign(node_80_tpl.style, {
        color: 'var(--text-secondary-col)',
        'font-size': 'var(--fs-md-fs)',
        width: 'var(--col-date-w)',
      })
      node_79_tpl.appendChild(node_80_tpl)
      const node_81_tpl = document.createElement('span')
      node_81_tpl.dataset.mirrorId = 'node-81[' + index + ']'
      node_81_tpl._loopItem = entry
      node_81_tpl.dataset.mirrorName = 'CellProject'
      node_81_tpl.textContent = entry.project
      Object.assign(node_81_tpl.style, {
        color: 'var(--text-col)',
        'font-size': 'var(--fs-md-fs)',
        width: 'var(--col-project-w)',
        'font-weight': '500',
      })
      node_79_tpl.appendChild(node_81_tpl)
      const node_82_tpl = document.createElement('span')
      node_82_tpl.dataset.mirrorId = 'node-82[' + index + ']'
      node_82_tpl._loopItem = entry
      node_82_tpl.dataset.mirrorName = 'CellClient'
      node_82_tpl.textContent = entry.client
      Object.assign(node_82_tpl.style, {
        color: 'var(--text-secondary-col)',
        'font-size': 'var(--fs-md-fs)',
        width: 'var(--col-client-w)',
      })
      node_79_tpl.appendChild(node_82_tpl)
      const node_83_tpl = document.createElement('span')
      node_83_tpl.dataset.mirrorId = 'node-83[' + index + ']'
      node_83_tpl._loopItem = entry
      node_83_tpl.dataset.mirrorName = 'CellTask'
      node_83_tpl.textContent = entry.task
      ...
      node_79_tpl.appendChild(node_84_tpl)
      const node_85_tpl = document.createElement('div')
      node_85_tpl.dataset.mirrorId = 'node-85[' + index + ']'
      node_85_tpl._loopItem = entry
      node_85_tpl.dataset.mirrorName = 'Frame'
      ...
      if (entry.billable) {
        ...
        node_86_tpl.dataset.mirrorName = 'Icon'
        node_86_tpl.textContent = 'circle-check'
        node_86_tpl.setAttribute('data-icon-color', 'var(--success-ic)')
        node_86_tpl.setAttribute('data-icon-size', 'var(--icon-md-is)')
        ...
        node_86_tpl.dataset.iconSize = 'var(--icon-md-is)'
        node_86_tpl.dataset.iconColor = 'var(--success-ic)'
        node_86_tpl.dataset.iconWeight = '2'
        _runtime.loadIcon(node_86_tpl, 'circle-check')
        node_85_tpl.appendChild(node_86_tpl)
      }
      if (!entry.billable) {
        const node_87_tpl = document.createElement('span')
        node_87_tpl.dataset.mirrorId = 'node-87[' + index + ']'
        node_87_tpl._loopItem = entry
        node_87_tpl.dataset.mirrorName = 'Icon'
        node_87_tpl.textContent = 'minus'
        node_87_tpl.setAttribute('data-icon-color', 'var(--text-muted-ic)')
        node_87_tpl.setAttribute('data-icon-size', 'var(--icon-md-is)')
        ...
        node_87_tpl.dataset.iconSize = 'var(--icon-md-is)'
        node_87_tpl.dataset.iconColor = 'var(--text-muted-ic)'
        node_87_tpl.dataset.iconWeight = '2'
        _runtime.loadIcon(node_87_tpl, 'minus')
        node_85_tpl.appendChild(node_87_tpl)
      }
      node_79_tpl.appendChild(node_85_tpl)
      itemContainer.appendChild(node_79_tpl)
      return itemContainer
    },
  }

  // Initial render
  const entriesData = (function (d) {
  ...
  let entriesFiltered = entriesData.filter(
    entry =>
      ($get('filterProject') == '' || entry.project == $get('filterProject')) &&
      ($get('filterClient') == '' || entry.client == $get('filterClient')) &&
      ($get('searchQuery') == '' ||
  ...
  entriesFiltered.forEach((entry, index) => {
    node_78_container.appendChild(node_78_container._eachConfig.renderItem(entry, index))
  })

  node_77.appendChild(node_78_container)

  node_68.appendChild(node_77)
  ...
  node_89.dataset.mirrorName = 'Text'
  node_89.textContent = '6 Einträge'
  Object.assign(node_89.style, {
    color: 'var(--text-muted-col)',
    'font-size': 'var(--fs-sm-fs)',
  })
  node_89.dataset.component = 'Text'
  node_88.appendChild(node_89)

  // Frame
  const node_90 = document.createElement('div')
  _elements['node-90'] = node_90
  node_90.dataset.mirrorId = 'node-90'
  node_90.dataset.mirrorName = 'Frame'
  ...
  node_90.dataset.component = 'Frame'
  // Text
  ...
  node_92.dataset.mirrorName = 'Text'
  node_92.textContent = '21.5h'
  Object.assign(node_92.style, {
    color: 'var(--text-col)',
    'font-size': 'var(--fs-lg-fs)',
    'font-weight': '600',
  })
  node_92.dataset.component = 'Text'
  node_90.appendChild(node_92)

  node_88.appendChild(node_90)

  node_68.appendChild(node_88)

  node_1.appendChild(node_68)
  ...
  initZagComponent(el) {
    ...
    if (isSearchable) {
      ...
      searchInput.addEventListener('keydown', e => {
        const visibleItems = Array.from(content.querySelectorAll('[data-value]')).filter(
...
_runtime.registerToken('$bg-bg', '#0f0f0f')
_runtime.registerToken('$card-bg', '#1a1a1a')
_runtime.registerToken('$card-alt-bg', '#151515')
_runtime.registerToken('$card-hover-bg', '#1f1f1f')
_runtime.registerToken('$row-hover-bg', '#222222')
_runtime.registerToken('$muted-bg', '#262626')
_runtime.registerToken('$muted-hover-bg', '#333333')
_runtime.registerToken('$accent-bg', '#3b82f6')
_runtime.registerToken('$accent-hover-bg', '#2563eb')
_runtime.registerToken('$success-bg', '#10b981')
_runtime.registerToken('$warning-bg', '#f59e0b')
_runtime.registerToken('$danger-bg', '#ef4444')
_runtime.registerToken('$text-col', '#f5f5f5')
_runtime.registerToken('$text-secondary-col', '#a3a3a3')
_runtime.registerToken('$text-muted-col', '#525252')
_runtime.registerToken('$accent-col', '#3b82f6')
_runtime.registerToken('$success-col', '#10b981')
_runtime.registerToken('$warning-col', '#f59e0b')
_runtime.registerToken('$danger-col', '#ef4444')
_runtime.registerToken('$text-muted-ic', '#525252')
_runtime.registerToken('$success-ic', '#10b981')
_runtime.registerToken('$muted-ic', '#666666')
_runtime.registerToken('$border-boc', '#2a2a2a')
_runtime.registerToken('$border-hover-boc', '#404040')
_runtime.registerToken('$space-sm-pad', 6)
_runtime.registerToken('$space-md-pad', 10)
_runtime.registerToken('$space-lg-pad', 14)
_runtime.registerToken('$space-xl-pad', 24)
_runtime.registerToken('$gap-xs-gap', 2)
_runtime.registerToken('$gap-sm-gap', 4)
_runtime.registerToken('$gap-md-gap', 6)
_runtime.registerToken('$gap-lg-gap', 10)
_runtime.registerToken('$gap-xl-gap', 12)
_runtime.registerToken('$gap-2xl-gap', 16)
_runtime.registerToken('$rad-sm-rad', 2)
_runtime.registerToken('$rad-md-rad', 4)
_runtime.registerToken('$rad-lg-rad', 6)
_runtime.registerToken('$fs-sm-fs', 10)
_runtime.registerToken('$fs-md-fs', 11)
_runtime.registerToken('$fs-lg-fs', 12)
_runtime.registerToken('$fs-xl-fs', 18)
_runtime.registerToken('$fs-2xl-fs', 20)
_runtime.registerToken('$icon-sm-is', 12)
_runtime.registerToken('$icon-md-is', 16)
_runtime.registerToken('$col-date-w', 70)
_runtime.registerToken('$col-project-w', 130)
_runtime.registerToken('$col-client-w', 100)
_runtime.registerToken('$col-task-w', 140)
_runtime.registerToken('$col-hours-w', 60)
_runtime.registerToken('$col-status-w', 32)
_runtime.registerToken('$filterProject', '')
_runtime.registerToken('$filterClient', '')
_runtime.registerToken('$searchQuery', '')
_runtime.registerToken('$newDate', '13.04.2026')
_runtime.registerToken('$newProject', 'Website Relaunch')
_runtime.registerToken('$newClient', 'Müller AG')
_runtime.registerToken('$newTask', '')
_runtime.registerToken('$newHours', 1)
_runtime.registerToken('$newBillable', true)
_runtime.registerToken('$entries', undefined)
