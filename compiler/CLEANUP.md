...
| 3 — `compiler/studio/`  | ✅ fertig         | 2026-04-29 — 6 dead modules removed (~2784 LOC): CoordinateTransformer, SpatialCache, ZIndexManager, ComponentIconMatcher, SelectionManager, SmartSizingService                                                          |
| 4 — IR & Backend Polish | ⬜ kontinuierlich | —                                                                                                                                                                                                                        |
| 5 — Parser zerlegen     | 🟡 6 von 7 Iter   | 2026-04-29 — TokenParser, StateDetector, TernaryParser, DataObjectParser, PropertyParser, InlinePropertyParser extrahiert (-1542 LOC, parser.ts: 5585→4043). Iter 6 (BodyParser) offen — Details in `SESSION-HANDOFF.md` |
