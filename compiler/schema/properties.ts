...
export const properties: PropertyDefinition[] = [
  ...
  },
  {
    ...
    type: 'number',
    category: 'visual',
    description: 'Scale transform (1 = original size)',
    defaultValue: 1,
  },
  {
    name: 'aspect',
    ...
    type: 'string',
    category: 'visual',
    description: 'Aspect ratio (square, video, 16/9, 1, …)',
  },
  {
    name: 'blur',
    aliases: [],
    type: 'number',
    category: 'visual',
    description: 'Element blur in pixels',
    unit: 'px',
    min: 0,
  },
  {
    ...
    type: 'number',
    category: 'visual',
    description: 'Backdrop blur in pixels (frosted glass)',
    unit: 'px',
    min: 0,
  },
  {
