...
// ============================================
// ICON
// Note: Icon handling might not be fully implemented in DOM backend
// ============================================

describe.skip('E2E: Icon Primitive (NOT YET IMPLEMENTED)', () => {
  it('generates icon span element', () => {
    const input = `
Icon as icon:
...
`
    const output = compile(input)
    // Icons typically render as spans with icon class
