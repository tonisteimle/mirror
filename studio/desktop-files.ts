...
// =============================================================================
// Project Toolbar (Title Bar)
//
// The old hamburger menu here used to host "New / Demo / Load / Save"
// project actions. Those moved to the App Menubar (studio/ui/menubar.ts)
// and the macOS-native menu in Tauri (src-tauri/src/main.rs). The header
// is now just a fixed title row above the file tree.
// =============================================================================
...
function initProjectToolbar() {
  ...
  // Create header element — title only, actions live in the App Menubar.
  const header = document.createElement('div')
  header.className = 'fp-header'
  header.innerHTML = `<span class="fp-title">Files</span>`
